...
import com.example.mt_me.databinding.ActivityAuthBinding
...
class AuthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.naverLoginBtn.setOnClickListener {
            ...
            NaverIdLoginSDK.initialize(this, getString(R.string.naver_client_id), getString(R.string.naver_client_secret), "Mt_me")
