...
// fragment 만드는 법: new > fragment > blank
...
class OneFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // FragmentOneBinding 불러오기 (inflater, container, 부모에 붙일지 여부)
        ...
        binding.fragButton.setOnClickListener {
            ...
            // 널이 아닌 경우에만 실행하도록 감싸줌
            context?.let { it1 -> // non-null 만 들어올 수 있음
                // this가 아닌 it1(널이 아닌 context)로
                AlertDialog.Builder(it1).run { // androidx.appcompat
                    setTitle("알림")
