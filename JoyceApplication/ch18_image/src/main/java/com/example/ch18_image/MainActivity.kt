...
import com.example.ch18_image.RetrofitConnection
import com.example.ch18_image.XmlAdapter
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener { // Drawer
        ...
        binding.btnSearch.setOnClickListener{
            if(MyApplication.checkAuth()) {
                ...
                val call: Call<XmlResponse> = RetrofitConnection.xmlNetworkService.getXmlList(
                    ...
                    10,
                    "xml",
                    "n/7fVcllIsn+SbZE9RQagnKysnAGx17cS7lGCITkUNvvd4jGID0W+FXrz1AGrjk3MZKTl5lzmcM+RxNpx2j56g==" // 일반인증키(Decoding)
                )
